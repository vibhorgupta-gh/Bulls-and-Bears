    ...
    axios.get(url + '/news_list')
      .then(response => {
        ...
        for(var i=0;i<response.data.length;i++){
           ...
           date.push(response.data[i].createdOn);
         }
                                ...
                                <div class="list-group">
                                    <a href="#" class="list-group-item list-group-item-action flex-column align-items-start active">
                                        <div class="d-flex w-100 justify-content-between">
                                            <h5 class="mb-1">{this.state.news_list[0]}</h5>
                                            <small>{this.state.createdOn[0]}</small>
                                        </div>
                                        <p class="mb-1">Description goes here as details are added </p>
                                        <small>about the news</small>
                                    </a>
                                    <a href="#" class="list-group-item list-group-item-action flex-column align-items-start">
                                        <div class="d-flex w-100 justify-content-between">
                                            <h5 class="mb-1">{this.state.news_list[1]}</h5>
                                            <small class="text-muted">{this.state.createdOn[1]}</small>
                                        </div>
                                        <p class="mb-1">Description goes here as details are added </p>
                                        <small>about the news</small>
                                    </a>
